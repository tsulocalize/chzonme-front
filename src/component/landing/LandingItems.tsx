  ...
  return (
    <S.Wrapper>
      ...
      <_Item mainText={"안내사항"} subText={"치즈온미는 아래와 같은 정책으로 운영됩니다."} gap={0}
             contents={[
               <_LiContent texts={[
                 "‘치지직’은 네이버(주)에서 운영하는 방송 플랫폼이며, 치즈온미는 ‘치지직’과 관련하여 어떠한 공식적인 제휴, 상표권, 또는 법적 이해관계도 가지고 있지 않습니다.",
                 "치즈온미는 ‘치지직’ 웹 애플리케이션에서 일반 사용자에게 공개된 범위 내의 데이터만을 수집 및 가공합니다.",
                 "데이터 수집 과정에서 일부 오류가 발생할 수 있습니다.",
                 "멤버십 혜택은 사전 예고 후 변경될 수 있으며, 혜택이 축소되는 경우에는 변경일로부터 최소 7일 전에 구독 중인 회원에게 명확히 안내드립니다.",
                 "멤버십 혜택이 변경되더라도 결제 완료된 구독 기간에 소급 적용되지 않습니다.",
                 "치즈온미는 ‘치지직’ 계정으로 간편 회원가입 기능을 제공하며, 이 과정에서 서비스 제공에 필수적인 최소한의 개인정보만을 수집·보관합니다.",
                 "서비스 관련 문의는 디스코드 채널을 통해 전달해주시고, 개별 문의는 카카오톡 오픈채팅을 통해 응답드립니다.",
